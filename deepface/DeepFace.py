...
def stream(db_path = '', model_name ='VGG-Face', detector_backend = 'ssd', distance_metric = 'cosine', enable_face_analysis = False, source = 0, time_threshold = 3, frame_threshold = 3):
